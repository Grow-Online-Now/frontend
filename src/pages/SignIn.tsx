...
export function SignIn() {
  ...
  async function onSubmit(data: SignInFormData) {
    ...
    try {
      ...
      if (signInError) {
        setError(signInError.message || t('auth.login.errors.invalid'))
        setIsLoading(false)
        return
      }
    ...
    <HelmetProvider>
      <div className="bg-background flex min-h-screen items-center justify-center px-4 py-12">
        <SEOHead
          ...
          canonicalUrl="https://growonline.now/login"
          lang={i18n.language}
        />
        ...
        <div className="w-full max-w-sm">
          ...
          {/* Header */}
          <div className="mb-8 text-center">
            <h1 className="text-foreground text-2xl font-semibold">{t('auth.login.title')}</h1>
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <span>{t('auth.login.social.github')}</span>
            </button>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div>
              ...
              <input
                ...
                {...register('email', {
                  required: t('auth.login.errors.email'),
                  pattern: {
                    value: /^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}$/i,
                    message: t('auth.login.errors.email'),
                  },
                })}
              />
              {errors.email && (
            ...
            <div>
              ...
              <input
                ...
                {...register('password', {
                  required: t('auth.login.errors.password'),
                })}
              />
              {errors.password && (
            ...
            >
              ...
              {isLoading ? t('auth.login.form.submitting') : t('auth.login.form.submit')}
            </button>
          </form>
