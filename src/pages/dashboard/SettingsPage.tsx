    ...
    <div className="max-w-2xl">
      ...
      <Tabs defaultValue="profile" className="w-full">
        <TabsList className="mb-6 w-full justify-start">
          ...
          <TabsTrigger value="language">{t('dashboard.settings.tabs.language')}</TabsTrigger>
          <TabsTrigger value="account">{t('dashboard.settings.tabs.account')}</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="notifications">
          <DashboardCard titleKey="dashboard.settings.notifications.title">
            <InfoHint
              textKey="dashboard.hints.settings.notifications"
              variant="tip"
              className="mb-6"
            />
        ...
        <TabsContent value="language">
          <DashboardCard titleKey="dashboard.settings.language.title">
