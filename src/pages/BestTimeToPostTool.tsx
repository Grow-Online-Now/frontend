...
// Best times data based on industry and platform
...
function generateHeatmapData(platform: Platform, industry: Industry): TimeSlot[] {
  ...
  for (let day = 0; day < 7; day++) {
    for (let hour = 6; hour <= 22; hour++) {
      ...
      // Check if adjacent to best time
      ...
      if (isBest) {
        ...
        // Weekends generally lower engagement for B2B
        (platform === 'linkedin' && (day === 5 || day === 6)) ||
      ...
      <div className="bg-background min-h-screen">
        ...
        <main className="pt-24 pb-24">
          ...
          <section className="mx-auto mt-12 max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              <Card>
                <CardHeader title={t('tools.bestTime.input.platform')} />
            ...
            <AnimatePresence>
              {heatmapData && bestTimes && (
                ...
                >
                  <Card>
                    <CardHeader title={t('tools.bestTime.heatmap.title')} />
