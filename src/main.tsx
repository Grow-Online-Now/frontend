...
const CreateTextPostPage = lazy(() => import('./pages/dashboard/CreateTextPostPage.tsx'))
const CreateMediaPostPage = lazy(() => import('./pages/dashboard/CreateMediaPostPage.tsx'))
