  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        >
          <div className="bg-[#FF0000]/10 mb-3 flex h-10 w-10 items-center justify-center rounded-lg">
        ...
        >
          <div className="bg-[#9146FF]/10 mb-3 flex h-10 w-10 items-center justify-center rounded-lg">
        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2">
            {(['clip', 'vod'] as const).map((type) => (
              ...
              >
                {t(
                  `dashboard.automations.wizard.source.${type === 'clip' ? 'clips' : 'vods'}`,
                )}
              </button>
            ))}
          </div>
