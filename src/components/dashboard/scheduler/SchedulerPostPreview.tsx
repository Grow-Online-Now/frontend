...
import type { PostResponse, PostSocialAccount } from '@/types/posts'
  ...
  return (
    <div className={cn('w-[300px]', className)}>
      {targetPlatform === 'twitter' && (
        <TwitterSchedulerPreview account={account} caption={truncatedCaption} />
      )}
      {targetPlatform === 'instagram' && (
        <InstagramSchedulerPreview account={account} caption={truncatedCaption} />
      )}
      {targetPlatform === 'linkedin' && (
        <LinkedInSchedulerPreview account={account} caption={truncatedCaption} />
      )}
      {targetPlatform === 'facebook' && (
        <FacebookSchedulerPreview account={account} caption={truncatedCaption} />
      )}
      {targetPlatform === 'tiktok' && (
        <TikTokSchedulerPreview account={account} caption={truncatedCaption} />
      )}
      {targetPlatform === 'youtube' && (
        <YouTubeSchedulerPreview account={account} caption={truncatedCaption} />
      )}
      {targetPlatform === 'pinterest' && (
        <PinterestSchedulerPreview account={account} caption={truncatedCaption} />
      )}
...
function PinterestSchedulerPreview({
  ...
  return (
    <div className="bg-card border-border overflow-hidden rounded-2xl border">
      ...
      <div className="bg-muted relative aspect-[2/3] max-h-[250px]">
        <div className="flex h-full items-center justify-center">
...
function GenericSchedulerPreview({
  ...
  return (
    <div className="bg-card border-border overflow-hidden rounded-2xl border p-4">
